...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ea2-kjw.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ea2-kjw.containers.anotherwebservice.com/
...
```
git clone git@github.com:Siraj-Ahamed/container-ea2-kjw.git
cd container-ea2-kjw
```
...
```
docker attach container-ea2-kjw
```
